...
urlpatterns = [
    ...
    path('lect-assignment/<str:pk>/<str:assign_pk>/', views.lectAssignment, name="lect-assignment"),
    path('update-assignment/<str:pk>/<str:assign_pk>/<str:assignment_pk>/', views.updateAssignment, name="update-assignment"),
    path('delete-assignment/<str:pk>/<str:assign_pk>/<str:assignment_pk>/', views.deleteAssignment, name="delete-assignment"),
    path('lect-assignment-submitted/<str:pk>/<str:assign_pk>/<str:assignment_pk>/', views.lectAssignmentSubmitted, name="lect-assignment-submitted"),
